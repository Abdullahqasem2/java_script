...
const Home = (props) => {
    return(
        ...
        <div class="nt-item"><span class="new">new</span>asd asd asd  </div>
        <div class="nt-item"><span class="strategy">strategy</span>Ihezkel hezkel hezkel</div>
        <div class="nt-item"><span class="racing">racing</span>osod wa hazakel</div>
        </div>
        </div>
        </div>
        ...
        <p><a href="#">Abdullah Qasem</a> <span>on</span> Lorem ipsum dolor sit amet, co</p>
